...
const MOUContent = ({ hospitalName, signatoryName, effectiveDate, bankAccountNumber, bankName, bankBranch, bankIfsc, bankAddress, professionalFee }) => {
    ...
    const fee = professionalFee || 'As per agreement';
    ...
    return (
        <div className="mou-document text-sm leading-relaxed text-gray-700">
            ...
            <p className="mb-4">
                ...
                registered office at {bankAddress || '________________'} (Hereinafter referred as <b>"{hosp}"</b>)
            </p>
            ...
            <p className="mb-3">
                Ezeehealth (Dual Mirror Healthcare Pvt Ltd) is a digitally enabled platform for Doctors and
            ...
            <p className="mb-4">
                In order to enable it's patients to avail specialty treatment <b>Ezeehealth (EH)</b> and
            ...
            {/* PURPOSE */}
            <p className="font-bold text-gray-900 mt-4 mb-2">PURPOSE OF THIS AGREEMENT</p>
            <p className="mb-4">
            ...
            {/* TERM */}
            <p className="font-bold text-gray-900 mt-4 mb-2">TERM</p>
            <p className="mb-4">
            ...
            {/* PAYMENT TERMS */}
            <p className="font-bold text-gray-900 mt-4 mb-2">PAYMENT TERMS</p>
            <p className="mb-3">For the Patients of <b>{hosp}</b>:</p>
            <p className="mb-3">
                Ezeehealth will collect the Fee on behalf of <b>{hosp}</b> for providing distinct clinical
            ...
            <p className="mb-3">
                The Tertiary healthcare treatment would be provided by any of the partner Specialty hospital
            ...
            <p className="mb-3">
                The Parties expressly agree that the Fee payable to <b>{hosp}</b> is a primary obligation of the
            ...
            <ul className="list-disc pl-5 mb-3 space-y-2">
                <li>
                    The Fee to <b>{hosp}</b> is for 'distinct clinical services' only and does not constitute a
                    referral commission, in line with the Medical Council of India (Professional Conduct, Etiquette
                    and Ethics) Regulations, 2002
                </li>
                <li>
                    Applicable taxes (including GST) shall be levied and paid as per Indian law
                </li>
                <li>
                    Bank details of the {hosp} is as follows:
            ...
            {/* CONFIDENTIALITY */}
            <p className="font-bold text-gray-900 mt-4 mb-2">CONFIDENTIALITY</p>
            <p className="mb-4">
            ...
            {/* BRANDING */}
            <p className="font-bold text-gray-900 mt-4 mb-2">BRANDING</p>
            <p className="mb-4">
            ...
            {/* TERMINATION */}
            <p className="font-bold text-gray-900 mt-4 mb-2">TERMINATION</p>
            <p className="mb-4">
            ...
            {/* FORCE MAJEURE */}
            <p className="font-bold text-gray-900 mt-4 mb-2">FORCE MAJEURE</p>
            <p className="mb-4">
            ...
            {/* INDEMNITY */}
            <p className="font-bold text-gray-900 mt-4 mb-2">INDEMNITY</p>
            <p className="mb-4">
            ...
            <p className="font-bold text-gray-900 mt-4 mb-2">LIMITATION OF LIABILITY</p>
            <p className="mb-4">
            ...
            {/* DISPUTE RESOLUTION */}
            <p className="font-bold text-gray-900 mt-4 mb-2">DISPUTE RESOLUTION</p>
            <p className="mb-4">
            ...
            {/* AUTHORIZATION */}
            <p className="font-bold text-gray-900 mt-4 mb-2">AUTHORIZATION</p>
            <p className="mb-4">
            ...
            {/* NOTICES */}
            <p className="font-bold text-gray-900 mt-4 mb-2">NOTICES</p>
            <p className="mb-4">
            ...
            {/* SEVERABILITY */}
            <p className="font-bold text-gray-900 mt-4 mb-2">SEVERABILITY</p>
            <p className="mb-4">
            ...
            <div className="border-t border-gray-200 pt-4 mt-6">
                <p className="font-bold text-gray-900 mb-1">Appendix A</p>
                <p className="font-bold text-gray-900 mb-3">Distinct Clinical Services</p>
            ...
            {/* Appendix B */}
            <div className="border-t border-gray-200 pt-4 mt-6">
                <p className="font-bold text-gray-900 mb-1">Appendix B</p>
                <p className="font-bold text-gray-900 mb-3">EZEEHEALTH RESPONSIBILITIES AND UNDERTAKINGS</p>
                <p className="mb-3">
                    Ezeehealth shall provide <b>"{hosp}"</b> a digital platform, patient concierge services and
                ...
                <p className="mb-3">
                    The Ezeehealth's team with digitally enabled processes will follow-up with the patients and
                ...
                <ul className="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <li>All concerned with the co-management of the treatment are kept in the loop so that patients experience seamless care</li>
                </ul>
                <p className="mb-3">
                ...
                <ul className="list-disc pl-5 mb-3 space-y-2">
                    <li>
                        If a case (episode) is brought through Ezeehealth platform or its representative, the patient
                    ...
                    <li>
                        Ezeehealth shall not be liable for delays, failures, or actions of the Hospital or its staff
            ...
            {/* Appendix C */}
            <div className="border-t border-gray-200 pt-4 mt-6">
                <p className="font-bold text-gray-900 mb-1">Appendix C</p>
                <p className="font-bold text-gray-900 mb-3">PROFESSIONAL FEE DISCLOSURE FORM</p>
